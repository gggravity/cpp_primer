...
{
  auto ret = find_if (vs.begin(), vs.end(), [N] (const SalesData &sd) { return sd.avg_price() > N; });
...
int main()
{
  ...
  vector<SalesData> vs {{"10-XXX", 1, 10}, {"20-XXX", 1, 20}, {"30-XXX", 1, 30},
                        {"10-XXX", 1, 10}, {"40-XXX", 1, 40}, {"20-XXX", 1, 20}};
