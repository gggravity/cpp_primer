...
quote::quote (const quote &other) : price (other.price), book_number (other.book_number)
{
...
quote::quote (quote &&other) noexcept : price (other.price), book_number (std::move (other.book_number))
{
...
quote::~quote() { cout << "quote destructor called..." << endl; }
