...
limited_discount::limited_discount (const limited_discount &other) :
...
limited_discount::limited_discount (limited_discount &&other) noexcept :
...
limited_discount::~limited_discount ()
  {
    cout << "limited_quote destructor called..." << endl;
  }
