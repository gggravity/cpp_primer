...
class C : public B
   ...
   public:
      ...
      C (const string &a, const string &b, string c) :
          B(a, b),
          c(std::move(c))
        {
          cout << "calling C ..." << endl;
...
class Z : public X, public Y
   ...
   public:
      ...
      Z (const string &x, const string &y, string z) :
          X(x),
          Y(y),
          z(std::move(z))
        {
