...
struct Base
{
  void bar (int) { cout << "calling bar (int) ..." << endl; }
...
{
  void bar (char) { cout << "calling bar (char) ..." << endl; }

  void foo (char) { cout << "calling foo (char) ..." << endl; }
...
{
  void foo (int) { cout << "calling foo (int) ..." << endl; }
