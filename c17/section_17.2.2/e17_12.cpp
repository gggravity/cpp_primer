...
struct Quiz
    {
        Quiz (const string &name, const string &results_string) :
            name(name)
          {
...
template < typename Quiz >
auto print_result (Quiz quiz)
  {
...
template < typename Quiz >
auto set_score (Quiz &quiz, size_t position, bool result)
  {
    --position;
...
template < typename Quiz >
auto get_results (Quiz quiz, Quiz answers)
  {
