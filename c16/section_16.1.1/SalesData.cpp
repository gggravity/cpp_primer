...
SalesData::SalesData (string book_number) : SalesData (std::move (book_number), 0, 0)
{
...
const string &SalesData::isbn() const { return m_book_no; }

void SalesData::set_isbn (const string &book_no) { m_book_no = book_no; }

unsigned int SalesData::units_sold() const { return m_units_sold; }

void SalesData::set_units_sold (unsigned int units_sold) { m_units_sold = units_sold; }

double SalesData::revenue() const { return m_revenue; }

void SalesData::set_revenue (double revenue) { m_revenue = revenue; }
...
SalesData::SalesData (const char *ISBN) : m_book_no (ISBN) {}

SalesData::operator string() const { return isbn(); }
