...
public:
  ...
  Vector (initializer_list<T> initializer_list) : elements (nullptr), first_free (nullptr), cap (nullptr)
  {
  ...
  [[nodiscard]] inline size_t size() const { return first_free - elements; }
    ...
    if (elements)
      {
        ...
        //                  alloc.destroy(--ptr);
        //                }
        for_each (elements, first_free, [] (T &t) { alloc.destroy (&t); });
