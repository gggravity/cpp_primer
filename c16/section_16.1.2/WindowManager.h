...
public:
  ...
  void add_screen (const char c) { screens.emplace_back (fixed_screen {c}); }

  size_t screen_count() { return screens.size(); }

  void print_screen (ostream &os, size_t i) { screens[i].display (os); }
