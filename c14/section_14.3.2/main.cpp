...
try
  {
    ...
    // the below are comparing content.
...
//
//    cout << str_blob1 << " == " << str_blob2 << " " << ( str_blob1 == str_blob2 ) << endl;
//    cout << str_blob1 << " != " << str_blob2 << " " << ( str_blob1 != str_blob2 ) << endl;
//    cout << str_blob2 << " == " << str_blob2 << " " << ( str_blob2 == str_blob2 ) << endl;
//    cout << str_blob2 << " == " << str_blob3 << " " << ( str_blob2 == str_blob3 ) << endl;
//
...
//
//    cout << str_blob_ptr1 << " == " << str_blob_ptr2 << " " << ( str_blob_ptr1 == str_blob_ptr2 ) << endl;
//    cout << str_blob_ptr1 << " != " << str_blob_ptr2 << " " << ( str_blob_ptr1 != str_blob_ptr2 ) << endl;
//    cout << str_blob_ptr2 << " == " << str_blob_ptr2 << " " << ( str_blob_ptr2 == str_blob_ptr2 ) << endl;
//    cout << str_blob_ptr2 << " == " << str_blob_ptr3 << " " << ( str_blob_ptr2 == str_blob_ptr3 ) << endl;
