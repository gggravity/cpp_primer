...
String::String (initializer_list<char> initializer_list) : elements (nullptr), first_free (nullptr), cap (nullptr)
{
...
String::String (String &&other) noexcept : elements (other.elements), first_free (other.first_free), cap (other.cap)
{
